                ...
                <div style={rowStyle}>
                  ...
                  <div style={{ display: "flex", flexDirection: "row" }}>
                    <input
                      ...
                      style={{ padding: "8px", marginRight: "10px", color: "red" }}
                    />
                    <div style={inputWrapper1}>
                      <button onClick={fetchVoyage} style={{ padding: "8px 16px", width: "15rem" }}>
                        {loading ? "Loading..." : "Fetch Voyage"}
                      </button>
                    </div>
                    <div style={{ ...inputWrapper1, marginLeft: "1rem" }}>
              ...
              {voyage && (
                <div>
                  ...
                  <div style={{
                    ...
                    paddingBottom: "1.1rem", width: "90vw", margin: "auto"
                  }}>
                  ...
                  <div style={{
                    ...
                    gap: "10px", paddingBottom: "1.1rem", width: "90vw", margin: "auto"
                  }}>
                    {/* Min Price */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", flex: 1 }}>
                  ...
                  <div style={{
                    display: "flex", gap: "10px",
                    margin: "auto", marginBottom: "20px", justifyContent: "space-between", width: "90vw",
                  }}>
                  ...
                  <div style={{ display: "flex", gap: "10px", width: "90vw", margin: "auto", marginBottom: "20px" }}>
                    {/* Vehicle Name */}
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", flex: 1 }}>
